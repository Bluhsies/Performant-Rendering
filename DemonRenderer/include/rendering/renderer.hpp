...
private:
	...
	*/
	...
	static uint32_t s_ID; //!< Static variable use to check for redundant bind calls.	
	static ViewPort s_viewID; //!< Static instance of the Viewport struct, use to check if the viewport has already been bound or not.
